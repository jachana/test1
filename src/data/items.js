...
export const ITEMS = Object.fromEntries([
  ...
  { id: 'raw_salmon', name: 'Salmon', icon: '🐡', type: 'food', food: 10, wt: 9, value: 12 },
  { id: 'northern_pike', name: 'Northern Pike', icon: '🎏', type: 'food', food: 14, wt: 9, value: 35 },
  { id: 'rainbow_trout', name: 'Rainbow Trout', icon: '🌈', type: 'food', food: 18, wt: 9, value: 80 },
  { id: 'meat', name: 'Meat', icon: '🥩', type: 'food', food: 12, wt: 18, value: 5 },

  // ------------------------------------------------------ quest-grade gear
  W('spike_sword', 'Spike Sword', '🗡️', 'sword', 24, 21, 165, 6000),
  W('serpent_sword', 'Serpent Sword', '🐍', 'sword', 30, 25, 140, 9000),
  W('katana', 'Katana', '🗡️', 'sword', 22, 16, 130, 1500),
  W('scimitar', 'Scimitar', '🗡️', 'sword', 19, 13, 190, 150),
  W('knight_axe', 'Knight Axe', '🪓', 'axe', 30, 22, 210, 20000),
  W('barbarian_axe', 'Barbarian Axe', '🪓', 'axe', 25, 16, 180, 500),
  W('obsidian_lance', 'Obsidian Lance', '🔱', 'axe', 28, 14, 300, 3000, { twoHanded: true }),
  W('dragon_lance', 'Dragon Lance', '🐲', 'axe', 33, 15, 380, 9000, { twoHanded: true }),
  W('skull_staff', 'Skull Staff', '☠️', 'club', 26, 25, 320, 12000),
  A('dark_armor', 'Dark Armor', '🖤', 'armour', 10, 1200, 400),
  A('demon_armor', 'Demon Armor', '😈', 'armour', 16, 1100, 200000),
  A('blue_robe', 'Blue Robe', '🔵', 'armour', 10, 220, 20000),
  A('golden_legs', 'Golden Legs', '🟡', 'legs', 10, 700, 200000),
  A('warrior_helmet', 'Warrior Helmet', '⛑️', 'helmet', 9, 500, 5000),
  A('crusader_helmet', 'Crusader Helmet', '✝️', 'helmet', 11, 500, 12000),
  S('vampire_shield', 'Vampire Shield', '🦇', 34, 570, 15000),
  S('dwarven_shield', 'Dwarven Shield', '⚒️', 22, 400, 100),
  { id: 'might_ring', name: 'Might Ring', icon: '💍', type: 'armour', slot: 'ring', arm: 3, wt: 20, value: 5000 },
  { id: 'crystal_ring', name: 'Crystal Ring', icon: '💎', type: 'armour', slot: 'ring', arm: 0, wt: 20, value: 250, skillBonus: { fishing: 5 } },
  { id: 'energy_ring', name: 'Energy Ring', icon: '⚡', type: 'armour', slot: 'ring', arm: 0, wt: 20, value: 2000, regenBonus: 1, skillBonus: { all: 2 } },

  // ------------------------------------------------- classic drops and finds
  W('two_handed_sword', 'Two Handed Sword', '⚔️', 'sword', 40, 15, 890, 950, { twoHanded: true }),
  W('broadsword', 'Broadsword', '🗡️', 'sword', 27, 18, 385, 500),
  W('carlin_sword', 'Carlin Sword', '🗡️', 'sword', 19, 14, 300, 118),
  W('ice_rapier', 'Ice Rapier', '❄️', 'sword', 42, 10, 170, 5000),
  W('djinn_blade', 'Djinn Blade', '🧞', 'sword', 35, 22, 210, 15000),
  W('halberd', 'Halberd', '🔱', 'axe', 30, 18, 500, 400, { twoHanded: true }),
  W('war_axe', 'War Axe', '🪓', 'axe', 43, 22, 250, 12000),
  W('morning_star', 'Morning Star', '⭐', 'club', 25, 12, 172, 90),
  W('dragon_hammer', 'Dragon Hammer', '🔨', 'club', 38, 20, 380, 2000),
  W('clerical_mace', 'Clerical Mace', '⚜️', 'club', 26, 18, 250, 3000),
  A('scale_armor', 'Scale Armor', '🧥', 'armour', 6, 1100, 260),
  A('golden_armor', 'Golden Armor', '🟡', 'armour', 13, 1100, 20000),
  A('dragon_scale_mail', 'Dragon Scale Mail', '🐲', 'armour', 15, 950, 100000),
  A('legion_helmet', 'Legion Helmet', '⛑️', 'helmet', 4, 410, 200),
  A('viking_helmet', 'Viking Helmet', '⛑️', 'helmet', 5, 420, 260),
  A('iron_helmet', 'Iron Helmet', '⛑️', 'helmet', 6, 1200, 390),
  A('devil_helmet', 'Devil Helmet', '😈', 'helmet', 11, 480, 40000),
  A('soldier_helmet', 'Soldier Helmet', '🪖', 'helmet', 4, 420, 110),
  S('steel_shield', 'Steel Shield', '🛡️', 26, 500, 500),
  S('battle_shield', 'Battle Shield', '🛡️', 25, 550, 300),
  S('copper_shield', 'Copper Shield', '🛡️', 16, 450, 100),
  S('black_shield', 'Black Shield', '🖤', 32, 500, 10000),
  S('crown_shield', 'Crown Shield', '👑', 33, 590, 8000),
  S('mastermind_shield', 'Mastermind Shield', '🧠', 37, 570, 50000),
  { id: 'bronze_amulet', name: 'Bronze Amulet', icon: '📿', type: 'armour', slot: 'amulet', arm: 1, wt: 42, value: 100 },
  { id: 'platinum_amulet', name: 'Platinum Amulet', icon: '📿', type: 'armour', slot: 'amulet', arm: 3, wt: 42, value: 2000 },
  { id: 'time_ring', name: 'Time Ring', icon: '⏳', type: 'armour', slot: 'ring', arm: 0, wt: 20, value: 2000, haste: 0.05 },
  { id: 'stealth_ring', name: 'Stealth Ring', icon: '🫥', type: 'armour', slot: 'ring', arm: 0, wt: 20, value: 2000, skillBonus: { all: 2 } },
  { id: 'sword_ring', name: 'Sword Ring', icon: '💍', type: 'armour', slot: 'ring', arm: 0, wt: 20, value: 100, skillBonus: { sword: 3 } },
  { id: 'club_ring', name: 'Club Ring', icon: '💍', type: 'armour', slot: 'ring', arm: 0, wt: 20, value: 100, skillBonus: { club: 3 } },
  { id: 'axe_ring', name: 'Axe Ring', icon: '💍', type: 'armour', slot: 'ring', arm: 0, wt: 20, value: 100, skillBonus: { axe: 3 } },

  // ------------------------------------------------------------------- gems
  { id: 'small_diamond', name: 'Small Diamond', icon: '💎', type: 'misc', wt: 1, value: 300 },
  { id: 'small_sapphire', name: 'Small Sapphire', icon: '🔷', type: 'misc', wt: 1, value: 250 },
  { id: 'small_emerald', name: 'Small Emerald', icon: '💚', type: 'misc', wt: 1, value: 250 },
  { id: 'small_ruby', name: 'Small Ruby', icon: '❤️', type: 'misc', wt: 1, value: 250 },
  { id: 'small_amethyst', name: 'Small Amethyst', icon: '💜', type: 'misc', wt: 1, value: 200 },
  { id: 'white_pearl', name: 'White Pearl', icon: '⚪', type: 'misc', wt: 1, value: 160 },
  { id: 'black_pearl', name: 'Black Pearl', icon: '⚫', type: 'misc', wt: 1, value: 280 },
  { id: 'talon', name: 'Talon', icon: '🦅', type: 'misc', wt: 1, value: 400 },
  { id: 'gold_ring', name: 'Gold Ring', icon: '💛', type: 'misc', wt: 2, value: 500 },
  ...
  { id: 'skull', name: 'Skull', icon: '💀', type: 'misc', wt: 20, value: 30 },
  { id: 'big_bone', name: 'Big Bone', icon: '🦴', type: 'misc', wt: 45, value: 40 },
  { id: 'behemoth_claw', name: 'Behemoth Claw', icon: '🦶', type: 'misc', wt: 30, value: 2000 },
  { id: 'demon_horn', name: 'Demon Horn', icon: '🐐', type: 'misc', wt: 20, value: 1000 },
  { id: 'vampire_dust', name: 'Vampire Dust', icon: '🌫️', type: 'misc', wt: 5, value: 800 },
  { id: 'green_dragon_scale', name: 'Green Dragon Scale', icon: '💚', type: 'misc', wt: 12, value: 400 },
  { id: 'green_dragon_leather', name: 'Green Dragon Leather', icon: '🟩', type: 'misc', wt: 12, value: 400 },
  { id: 'red_dragon_leather', name: 'Red Dragon Leather', icon: '🟥', type: 'misc', wt: 12, value: 600 },
  { id: 'golden_mug', name: 'Golden Mug', icon: '🍺', type: 'misc', wt: 18, value: 200 },
  { id: 'gemmed_book', name: 'Gemmed Book', icon: '📕', type: 'misc', wt: 30, value: 600 },
  { id: 'green_gem', name: 'Green Gem', icon: '💚', type: 'misc', wt: 1, value: 2000 },
  { id: 'silver_brooch', name: 'Silver Brooch', icon: '🔘', type: 'misc', wt: 4, value: 200 },
  { id: 'mind_stone', name: 'Mind Stone', icon: '🪨', type: 'misc', wt: 40, value: 500 },
  { id: 'spellbook', name: 'Spellbook', icon: '📘', type: 'misc', wt: 120, value: 150 },
